...
namespace EmployeeWageCalculation
{
    public class WageComputation
    {
        const int IS_PRESENT=1, IS_ABSENT = 0 , WAGE_PER_HR=20,FULL_DAY_HR=8,PART_TIME_HR=4,
            IS_FULL_DAY_PRESENT=1, IS_PART_TIME_PRESENT=2;
        ...
        public void EmpWageCalculation()
        {
            ...
            switch (check)
            {
                case IS_ABSENT: empHrs = 0;
                    break;
                case IS_FULL_DAY_PRESENT: empHrs = FULL_DAY_HR;
                    break;
                case IS_PART_TIME_PRESENT: empHrs = FULL_DAY_HR;
                    break;
            }
